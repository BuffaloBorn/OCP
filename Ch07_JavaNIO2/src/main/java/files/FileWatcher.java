...
public class FileWatcher implements Runnable, AutoCloseable {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        if (watcher.registerPath(Paths.get("/home/vitaly/IdeaProjects/OCP/Ch07_JavaNIO2/src/main/resources/test/7218049246468077320.tmp"), false, ENTRY_MODIFY, ENTRY_CREATE, ENTRY_DELETE)) {
